...
//  rasterize_line(d.x, d.y, c.x, c.y, Color::Black);
    ...
    if (gl)
      draw_pixels();
//    framebuffer.assign(framebuffer.size(), (unsigned char) brightness);
    unsigned char b = (unsigned char) (int) abs(brightness - ((int) (grid.ts / 20) % (2*brightness)));
...
// Rasterize a circle using Bresenham's circle algorithm, which relies on the Mid Point circle Algorithm.
  void DrawRend::rasterize_circle(float xCoordinate, float yCoordinate, float radius, Color color) {
    int tempX = 0;
    int tempY = radius;
    ...
    while (tempY >= tempX) {
      ...
      if (condition > 0) {
        tempY--;
        condition = condition + 4 * (tempX - tempY) + 10;
      } else {
        condition = condition + 4 * tempX + 6;
      }
      circle_draw_helper((int) xCoordinate, (int) yCoordinate, tempX, tempY, color);
    }
  }
...
//    Color color = particle.getColor() * multiplier + Color(1, 1, 1) * (1.0 - multiplier);
    rasterize_circle(xCoordinate - radius, yCoordinate - radius, radius * 2, particle.getColor());
//    rasterize_circle(xCoordinate, yCoordinate, radius, particle.color);
  }

    void DrawRend::particles_init() {
//        grid.add(Particle({200, 200}, 5, {}, {}, {128/255.0,128/255.0,128/255.0}, 0));
//        grid.add(Particle({400, 400}, 8, {}, {}, {128/255.0,128/255.0,128/255.0}, 1));
//        grid.add(Particle({700, 200}, 3, {}, {},{128/255.0,128/255.0,128/255.0}, 2));
//        grid.add(Particle({350, 600}, 30, {5, 5}, {},{128/255.0,128/255.0,128/255.0}, 3));
//        grid.add(Particle({150, 500}, 5, {}, {},{128/255.0,128/255.0,128/255.0}, 4));
//        grid.add(Particle({300, 200}, 3, {}, {},{128/255.0,128/255.0,128/255.0}, 5));
//        grid.add(Particle({600, 400}, 10, {}, {},{128/255.0,128/255.0,128/255.0}, 6));
//        grid.add(Particle({100, 100}, 5, {}, {}, {128/255.0,128/255.0,128/255.0}, 0));
//        grid.add(Particle({600, 600}, 8, {}, {}, {128/255.0,128/255.0,128/255.0}, 1));
//        grid.add(Particle({900, 300}, 3, {}, {},{128/255.0,128/255.0,128/255.0}, 2));
//        grid.add(Particle({750, 400}, 30, {5, 5}, {},{128/255.0,128/255.0,128/255.0}, 3));
//        grid.add(Particle({250, 500}, 5, {}, {},{128/255.0,128/255.0,128/255.0}, 4));
//        grid.add(Particle({100, 900}, 3, {}, {},{128/255.0,128/255.0,128/255.0}, 5));
//        grid.add(Particle({500, 200}, 10, {}, {},{128/255.0,128/255.0,128/255.0}, 6));
//        grid.add(Particle({201, 591}, 5, {}, {}, {128/255.0,128/255.0,128/255.0}, 0));
//        grid.add(Particle({915, 501}, 5, {}, {}, {128/255.0,128/255.0,128/255.0}, 0));
//        grid.add(Particle({291, 591}, 5, {}, {}, {128/255.0,128/255.0,128/255.0}, 0));
//        grid.add(Particle({678, 051}, 5, {}, {}, {128/255.0,128/255.0,128/255.0}, 0));
//        grid.add(Particle({61, 491}, 5, {}, {}, {128/255.0,128/255.0,128/255.0}, 0));
//        grid.add(Particle({961, 616}, 5, {}, {}, {128/255.0,128/255.0,128/255.0}, 0));
//        grid.add(Particle({865, 316}, 5, {}, {}, {128/255.0,128/255.0,128/255.0}, 0));
//        grid.add(Particle({391, 217}, 5, {}, {}, {128/255.0,128/255.0,128/255.0}, 0));
//        grid.add(Particle({600, 300}, 10, {}, {},{128/255.0,128/255.0,128/255.0}, 6));
//        grid.add(Particle({301, 891}, 5, {}, {}, {128/255.0,128/255.0,128/255.0}, 0));
//        grid.add(Particle({715, 201}, 5, {}, {}, {128/255.0,128/255.0,128/255.0}, 0));
//        grid.add(Particle({191, 191}, 5, {}, {}, {128/255.0,128/255.0,128/255.0}, 0));
//        grid.add(Particle({378, 51}, 5, {}, {}, {128/255.0,128/255.0,128/255.0}, 0));
//        grid.add(Particle({71, 391}, 5, {}, {}, {128/255.0,128/255.0,128/255.0}, 0));
...
//        grid.add(Particle({191, 317}, 5, {}, {}, {128/255.0,128/255.0,128/255.0}, 0));
        for (int i = 0; i < 100; i++) {
          grid.add(Particle(1920, 1280, 7, 25));
        }
    }
