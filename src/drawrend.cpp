...
//    rasterize_circle(xCoordinate, yCoordinate, radius, particle.color);
  ...
  void DrawRend::particles_init() {
    ...
    void DrawRend::particles_init() {
        ...
        grid.add(Particle({300, 200}, 3, 0.01, {}, {},{128/255.0,128/255.0,128/255.0}, 5));
        grid.add(Particle({600, 400}, 10, 0.01, {}, {},{128/255.0,128/255.0,128/255.0}, 6));
        grid.add(Particle({100, 100}, 5, 0.01, {}, {}, {128/255.0,128/255.0,128/255.0}, 0));
        grid.add(Particle({600, 600}, 8, 0.01, {}, {}, {128/255.0,128/255.0,128/255.0}, 1));
        grid.add(Particle({900, 300}, 3, 0.01, {}, {},{128/255.0,128/255.0,128/255.0}, 2));
        grid.add(Particle({750, 400}, 30, 0.01, {5, 5}, {},{128/255.0,128/255.0,128/255.0}, 3));
        grid.add(Particle({250, 500}, 5, 0.01, {}, {},{128/255.0,128/255.0,128/255.0}, 4));
        grid.add(Particle({100, 900}, 3, 0.01, {}, {},{128/255.0,128/255.0,128/255.0}, 5));
        grid.add(Particle({500, 200}, 10, 0.01, {}, {},{128/255.0,128/255.0,128/255.0}, 6));
        grid.add(Particle({201, 591}, 5, 0.03, {}, {}, {128/255.0,128/255.0,128/255.0}, 0));
        grid.add(Particle({915, 501}, 5, 0.03, {}, {}, {128/255.0,128/255.0,128/255.0}, 0));
        grid.add(Particle({291, 591}, 5, 0.03, {}, {}, {128/255.0,128/255.0,128/255.0}, 0));
        grid.add(Particle({678, 051}, 5, 0.03, {}, {}, {128/255.0,128/255.0,128/255.0}, 0));
        grid.add(Particle({61, 491}, 5, 0.03, {}, {}, {128/255.0,128/255.0,128/255.0}, 0));
        grid.add(Particle({961, 616}, 5, 0.03, {}, {}, {128/255.0,128/255.0,128/255.0}, 0));
        grid.add(Particle({865, 316}, 5, 0.03, {}, {}, {128/255.0,128/255.0,128/255.0}, 0));
        grid.add(Particle({391, 217}, 5, 0.03, {}, {}, {128/255.0,128/255.0,128/255.0}, 0));
        grid.add(Particle({600, 300}, 10, 0.01, {}, {},{128/255.0,128/255.0,128/255.0}, 6));
        grid.add(Particle({301, 891}, 5, 0.01, {}, {}, {128/255.0,128/255.0,128/255.0}, 0));
        grid.add(Particle({715, 201}, 5, 0.01, {}, {}, {128/255.0,128/255.0,128/255.0}, 0));
        grid.add(Particle({191, 191}, 5, 0.01, {}, {}, {128/255.0,128/255.0,128/255.0}, 0));
        grid.add(Particle({378, 51}, 5, 0.01, {}, {}, {128/255.0,128/255.0,128/255.0}, 0));
        grid.add(Particle({71, 391}, 5, 0.01, {}, {}, {128/255.0,128/255.0,128/255.0}, 0));
        grid.add(Particle({361, 616}, 5, 0.01, {}, {}, {128/255.0,128/255.0,128/255.0}, 0));
        grid.add(Particle({665, 616}, 5, 0.01, {}, {}, {128/255.0,128/255.0,128/255.0}, 0));
        grid.add(Particle({191, 317}, 5, 0.01, {}, {}, {128/255.0,128/255.0,128/255.0}, 0));
